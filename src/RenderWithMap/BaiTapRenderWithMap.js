...
// import './BaiTapRenderWithMap.css'

import style from './BaiTapRenderWithMap.module.css'
        ...
        const jsxPhim = mangPhim.map((phim, index) => {
            return (
                <div className="col-4" key={index}>
                    <div className="card">
                        {/* <img className={`card-img-top hinhAnhPhim`} src={phim.hinhAnh} alt="123" /> */}

                        {/* <img className={`card-img-top ${style.hinhAnhPhim}`} src={phim.hinhAnh} alt="123" /> */}
                        ...
                        } className={`card-img-top`} src={phim.hinhAnh} alt="123" />
                        ...
                        <div className="card-body">
                            ...
                            }} className="card-title">{phim.tenPhim.length > 50 ? <span>{phim.tenPhim.substr(0, 50)}...</span> : <span>{phim.tenPhim}</span>}</h4>
